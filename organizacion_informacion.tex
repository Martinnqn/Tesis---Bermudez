...
Pudimos abordar el problema de organizar la información de una ontología, tratando de maximizar la coherencia de la estructura generada usando apropiadamente sus relaciones semánticas. Como planteamos inicialmente, tuvimos que definir:
\begin{itemize}
    ...
    \end{itemize}
    \item El recorrido de la ontología para crear los siguientes niveles, seleccionando las relaciones \emph{rdfs:Domain}, \emph{owl:subPropertyOf}, \emph{rdfs:Range} y \emph{rdfs:subClassOf}.
\end{itemize}
