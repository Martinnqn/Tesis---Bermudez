...
La clase \emph{ContentClasification} contiene los métodos necesarios para clasificar y extraer las entidades más relevantes. Algunos de sus métodos más importantes se muestran en la Figura...

La clase \emph{ContentGrouping} solo posee dos metodos para generar los nuevos tópicos del Árbol de Entidades. En la Figura.. se muestra la implementación de esta clase.
