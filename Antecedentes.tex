...
En la lista \ref{list:constructores_axiomas} se agrupan los constructores del de axiomas, en la lista \ref{list:constructores_expresiones} los constructores de expresiones de clases y en la lista \ref{list:constructores_entity} los constructores de nivel de entidades.

 \begin{itemize}
  \label{list:constructores_axiomas}
    \captionof{listCap}{Constructores Axiomas}
...
\captionof{listCap}{Constructores Expresiones de Clase}
\begin{multicols}{2}
