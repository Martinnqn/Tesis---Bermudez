...
\subsection{Enfoques para abordar la GNL}
...
Se han desarrollado teorías para describir y construir de forma coherente las estructuras del texto, como la Teoría de Estructuración Retórica (RST)~\cite{mann1987rhetorical} y la Teoría de Centrado~\cite{grosz1986towards}, entre otras.

\subsubsection{Teoría de Estructuración Retórica}



\subsubsection{Teoría de centrado}
Esta teoría propone un conjunto de reglas, las cuales deben cumplirse para favorecer la coherencia del discurso. La afirmación más fundamental de la Teoría de Centrado es que, en la medida en que un discurso se adhiera a las restricciones centrales, su coherencia aumentará y la carga de inferencia sobre el oyente disminuirá\cite{kruijff1997topics}. Esta característica que aclama la teoría, resulta conveniente para el objetivo que busca nuestro trabajo, respecto al hecho de minimizar los esfuerzos de un usuario para comprender el dominio modelado en una ontología.
