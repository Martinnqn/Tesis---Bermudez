...
En la Figura~\ref{fig:modulos_plan_documento} se puede ver la integración del Organizador de Información con el Generador de Documento de Texto.
...
La enumeración de propiedades, subclases e individuos es simple. Para llevar a cabo la sintaxis requerida se consideró lo siguiente: 

\begin{itemize}
    \item Para las subclases se crearon los patrones de la Gramática~\ref{gram:subclases}.
\item Para los individuos se crearon patrones similares al de las subclases.
\item Para las propiedades se crearon los patrones de la Gramática~\ref{gram:propiedades}.
 \end{itemize}
...
En la Figura~\ref{fig:indice_secciones_wine} se visualiza el índice del documento. Podemos observar que su estructura es mucho más compacta que la estructura inicial presentada en la Figura~\ref{fig:caso_estudio_wine}.
